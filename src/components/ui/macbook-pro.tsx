...
/** MacBook device frame used to present web project screenshots. */
export function MacbookPro({
  ...
  // Project previews can render together on mobile, so keep every clip-path unique.
  const clipPathId = `macbook-screen-${useId().replaceAll(":", "")}`;
  ...
  return (
    ...
    >
      ...
      <rect fill="currentColor" x="74.52" y="21.32" width="501.22" height="323.85" rx="5" />
      {src ? (
        <image
          href={src}
          x="74.52"
      ...
      <path fill="#000" d="M298.14,21.02h54.07v6.5c0,1.56-1.27,2.82-2.82,2.82h-48.42c-1.56,0-2.82-1.27-2.82-2.82v-6.5Z" />
      <path
        fill="#acadaf"
        d="M19.04,362.77h611.92v10.39c0,5.95-4.83,10.79-10.79,10.79H29.83c-5.95,0-10.79-4.83-10.79-10.79v-10.39Z"
      />
      <path fill="#080d4c" d="M325.11,25.14c-1.99.03-1.99-3.09,0-3.06,1.99-.03,1.99,3.09,0,3.06Z" />
      ...
      <path fill="#8f9091" d="M278.11,362.6h94.05c0,3.63-2.95,6.58-6.58,6.58h-80.89c-3.63,0-6.58-2.95-6.58-6.58Z" />

      <defs>
        <clipPath id={clipPathId}>
          <rect x="74.52" y="21.32" width="501.22" height="323.85" rx="5" />
        </clipPath>
      </defs>
    </svg>
  );
