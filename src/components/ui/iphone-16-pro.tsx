...
/** iPhone device frame used to present mobile project screenshots. */
export function Iphone16Pro({
  ...
  // Mobile project cards can render together, so every SVG needs its own clip-path id.
  const clipPathId = `iphone-screen-${useId().replaceAll(":", "")}`;
  ...
  return (
    ...
    >
      ...
      <path
        fill="#000"
        d="M119.61,33.86h-38.93c-10.48-.18-10.5-15.78,0-15.96h38.93c4.41,0,7.98,3.57,7.98,7.98s-3.57,7.98-7.98,7.98Z"
      />
      <path fill="#080d4c" d="M118.78,29.21c-4.32.06-4.32-6.73,0-6.66,4.32-.06,4.32,6.73,0,6.66Z" />

      <defs>
        <clipPath id={clipPathId}>
          <rect x="14.08" y="12.81" width="171.98" height="374.37" rx="24.62" />
        </clipPath>
      </defs>
    </svg>
  );
